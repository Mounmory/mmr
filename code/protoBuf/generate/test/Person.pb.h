...
PROTOBUF_NAMESPACE_OPEN
template<> ::MMR::Person* Arena::CreateMaybeMessage<::MMR::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace MMR {
...
class Person final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MMR.Person) */ {
 public:
  ...
  public:
  void clear_addr();
  const ::MMR::Address& addr() const;
  PROTOBUF_NODISCARD ::MMR::Address* release_addr();
  ::MMR::Address* mutable_addr();
  void set_allocated_addr(::MMR::Address* addr);
  private:
  const ::MMR::Address& _internal_addr() const;
  ::MMR::Address* _internal_mutable_addr();
  public:
  void unsafe_arena_set_allocated_addr(
      ::MMR::Address* addr);
  ::MMR::Address* unsafe_arena_release_addr();
  ...
  // .MMR.Color color = 6;
  void clear_color();
  ::MMR::Color color() const;
  void set_color(::MMR::Color value);
  private:
  ::MMR::Color _internal_color() const;
  void _internal_set_color(::MMR::Color value);
  public:

  // @@protoc_insertion_point(class_scope:MMR.Person)
 private:
  class _Internal;
...
inline int32_t Person::id() const {
  // @@protoc_insertion_point(field_get:MMR.Person.id)
  return _internal_id();
}
...
inline void Person::set_id(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:MMR.Person.id)
}
...
inline std::string* Person::add_name() {
  ...
  // @@protoc_insertion_point(field_add_mutable:MMR.Person.name)
  return _s;
}
...
inline const std::string& Person::name(int index) const {
  // @@protoc_insertion_point(field_get:MMR.Person.name)
  return _internal_name(index);
}
inline std::string* Person::mutable_name(int index) {
  // @@protoc_insertion_point(field_mutable:MMR.Person.name)
...
inline void Person::set_name(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:MMR.Person.name)
}
...
inline void Person::set_name(int index, const char* value) {
  ...
  _impl_.name_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:MMR.Person.name)
}
inline void Person::set_name(int index, const void* value, size_t size) {
  _impl_.name_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:MMR.Person.name)
}
...
inline void Person::add_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:MMR.Person.name)
}
...
inline void Person::add_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.name_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:MMR.Person.name)
}
inline void Person::add_name(const void* value, size_t size) {
  _impl_.name_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:MMR.Person.name)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Person::name() const {
  // @@protoc_insertion_point(field_list:MMR.Person.name)
  return _impl_.name_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Person::mutable_name() {
  // @@protoc_insertion_point(field_mutable_list:MMR.Person.name)
  return &_impl_.name_;
}
...
inline const std::string& Person::sex() const {
  // @@protoc_insertion_point(field_get:MMR.Person.sex)
...
void Person::set_sex(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.sex_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:MMR.Person.sex)
}
inline std::string* Person::mutable_sex() {
  std::string* _s = _internal_mutable_sex();
  // @@protoc_insertion_point(field_mutable:MMR.Person.sex)
  return _s;
}
...
inline std::string* Person::release_sex() {
  // @@protoc_insertion_point(field_release:MMR.Person.sex)
...
inline void Person::set_allocated_sex(std::string* sex) {
  ...
  // @@protoc_insertion_point(field_set_allocated:MMR.Person.sex)
}
...
inline int32_t Person::age() const {
  // @@protoc_insertion_point(field_get:MMR.Person.age)
...
inline void Person::set_age(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:MMR.Person.age)
}
...
inline const ::MMR::Address& Person::_internal_addr() const {
  const ::MMR::Address* p = _impl_.addr_;
  return p != nullptr ? *p : reinterpret_cast<const ::MMR::Address&>(
      ::MMR::_Address_default_instance_);
}
inline const ::MMR::Address& Person::addr() const {
  // @@protoc_insertion_point(field_get:MMR.Person.addr)
...
inline void Person::unsafe_arena_set_allocated_addr(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:MMR.Person.addr)
}
inline ::MMR::Address* Person::release_addr() {
  
  ::MMR::Address* temp = _impl_.addr_;
...
inline ::MMR::Address* Person::unsafe_arena_release_addr() {
  // @@protoc_insertion_point(field_release:MMR.Person.addr)
  
  ::MMR::Address* temp = _impl_.addr_;
  _impl_.addr_ = nullptr;
  return temp;
}
inline ::MMR::Address* Person::_internal_mutable_addr() {
  
  if (_impl_.addr_ == nullptr) {
    auto* p = CreateMaybeMessage<::MMR::Address>(GetArenaForAllocation());
    _impl_.addr_ = p;
  }
  return _impl_.addr_;
}
inline ::MMR::Address* Person::mutable_addr() {
  ::MMR::Address* _msg = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:MMR.Person.addr)
  return _msg;
}
inline void Person::set_allocated_addr(::MMR::Address* addr) {
  ...
  _impl_.addr_ = addr;
  // @@protoc_insertion_point(field_set_allocated:MMR.Person.addr)
}
...
inline ::MMR::Color Person::_internal_color() const {
  return static_cast< ::MMR::Color >(_impl_.color_);
}
inline ::MMR::Color Person::color() const {
  // @@protoc_insertion_point(field_get:MMR.Person.color)
  return _internal_color();
}
inline void Person::_internal_set_color(::MMR::Color value) {
  
  _impl_.color_ = value;
}
inline void Person::set_color(::MMR::Color value) {
  _internal_set_color(value);
  // @@protoc_insertion_point(field_set:MMR.Person.color)
}
...
template <> struct is_proto_enum< ::MMR::Color> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::MMR::Color>() {
  return ::MMR::Color_descriptor();
}
