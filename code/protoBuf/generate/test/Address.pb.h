...
PROTOBUF_NAMESPACE_OPEN
template<> ::MMR::Address* Arena::CreateMaybeMessage<::MMR::Address>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace MMR {
...
class Address final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MMR.Address) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:MMR.Address)
 private:
  class _Internal;
...
inline int32_t Address::num() const {
  // @@protoc_insertion_point(field_get:MMR.Address.num)
...
inline void Address::set_num(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:MMR.Address.num)
}
...
inline const std::string& Address::addr() const {
  // @@protoc_insertion_point(field_get:MMR.Address.addr)
...
void Address::set_addr(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.addr_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:MMR.Address.addr)
}
inline std::string* Address::mutable_addr() {
  std::string* _s = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:MMR.Address.addr)
  return _s;
}
...
inline std::string* Address::release_addr() {
  // @@protoc_insertion_point(field_release:MMR.Address.addr)
...
inline void Address::set_allocated_addr(std::string* addr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:MMR.Address.addr)
}
