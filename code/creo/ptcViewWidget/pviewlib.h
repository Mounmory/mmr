/****************************************************************************
**
** Namespace pviewLib generated by dumpcpp v5.9.0 using
** D:\Qt\5.9\msvc2015_64\bin\dumpcpp.exe {F07443A6-02CF-4215-9413-55EE10D509CC}
** from the type library C:\Program Files (x86)\Common Files\PTC\pview.ocx
**
****************************************************************************/
...
public:
    ...
    property PVXConnectionID
For more information, see help context 0 in C:\Program Files\PTC\Creo 4.0\View Express\x86e_win64\obj\pview.hlp.
    */
...
public:
    ...
    : QAxWidget(parent, f)
    {
        setControl("{f07443a6-02cf-4215-9413-55ee10d509cc}");
    }
...
public:
    ...
    : QAxObject(parent)
    {
        setControl("{c304ae4c-15dd-47be-a7fb-a1d5220b4fb7}");
    }
...
public:
    ...
    : QAxObject(parent)
    {
        setControl("{58ec6d70-49c3-44f1-b466-88908f2c2373}");
    }
